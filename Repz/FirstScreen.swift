...
class FirstScreen: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func addIcons(key:String,object:NSMutableDictionary) {
        ...
        var pointStartPos = CGPointMake(object.valueForKey("startPosX") as! CGFloat, object.valueForKey("startPosY") as! CGFloat)
        pointStartPos = pointStartPos.ConvertCGPoint()
        icon.startPos = pointStartPos
        
        var pointOffset = CGPointMake(object.valueForKey("offsetX") as! CGFloat, object.valueForKey("offsetX") as! CGFloat)
        pointOffset = pointOffset.ConvertCGPoint()
        icon.offset = pointOffset
        ...
        if pathData != nil {
            ...
            for value in array {
                ...
                icon.path.append(pos.ConvertCGPoint())
            }
        }
    ...
    @IBAction func onCreateNewRecord(sender: AnyObject) {
        ...
        ThirdScreen.playName = self.newName.text!
    }
